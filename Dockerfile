...
# Install Terragrunt (0.29.7). Ref: https://github.com/gruntwork-io/terragrunt/releases
...
ADD https://amazon-eks.s3.us-west-2.amazonaws.com/1.19.6/2021-01-05/bin/linux/amd64/aws-iam-authenticator /usr/bin/
...
# Install Helm (3.6.0). Version histroy can be found at https://github.com/helm/helm/tags
ENV DESIRED_VERSION=v3.6.0
